...
package org.wso2.analytics.mb.internal;
 ...
 *
 * @scr.component name="analytics.mb.component" immediate="true"
 */
public class AnalyticsMBComponent {

    private static final Log log = LogFactory.getLog(AnalyticsMBComponent.class);
