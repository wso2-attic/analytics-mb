 ...
 */
package org.wso2.das4mb.multitenancy.styles.internal;
...
/**
 * Bundle activator of multi-tenancy styles
 */
public class Activator implements BundleActivator {
    ...
    /**
     * Register multi-tenancy UI style when bundle start
     *
     * @param bundleContext {@link BundleContext} object
     * @throws Exception
     */
    public void start(BundleContext bundleContext) throws Exception {
        ...
        if (reference != null) {
            ...
            try {
                ...
                log.error("Error occurred while bunlde activate.", e);
            }
        } else {
    ...
    /**
     * Unregister multi-tenancy UI style when bundle stop
     *
     * @param context {@link BundleContext} object
     * @throws Exception
     */
